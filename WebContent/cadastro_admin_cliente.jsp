		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<form action="CadastroCliente" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input type="tipo" name="tipo" value="${cliente.tipo }" class="form-control" id="tipoID" placeholder="Cliente" required>
			  </div>
			  <div class="form-group">
			  ...
			  <tr>
				<td>
					...
					<input type="hidden" type="text" value="${cliente.id}" name="clienteID" id="clienteID">
				</td>
			  </tr>
